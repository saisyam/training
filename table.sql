...
CREATE TABLE repository( item1_id SERIAL NOT NULL PRIMARY KEY,
                  id INT,
                  node_id TEXT,
                  name TEXT,
                  full_name TEXT,
                  ...
                  score INT,
                   topics TEXT [],
                  owner_id SERIAL NOT NULL REFERENCES owner(id),
                  license_id SERIAL NOT NULL REFERENCES license(id)
);
select * from owner
select * from license
select * from item
truncate table license,items,owner
