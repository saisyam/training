...
class Issue_url(Base):
    ...
    def __repr__(self):
        return "Issue_url<(id={},url='{}' repository_url='{}', labels_url='{}', comments_url='{}', events_url='{}', html_url='{}',node_id='{}',number={},title='{},'state='{}',locked='{}',milestone='{}',comments='{}',created_at='{}',updated_at='{}',closed_at='{}',author_association='{}',active_lock_reason='{}',body='{}',timeline_url='{}',performed_via_github_app='{}',state_reason='{}',user_id={},assignee_id={},assignees_id={},labels_id={},reactions_id={})>"\
                .format(self.id,self.url, self.repository_url, self.labels_url, self.comments_url, self.events_url, self.html_url,self.node_id,self.number,self.title,self.state,self.locked,self.milestone,self.comments,self.created_at,self.updated_at,self.closed_at,self.author_association,self.active_lock_reason,self.body,self.timeline_url,self.performed_via_github_app,self.state_reason,self.user_id,self.assignee_id,self.assignees_id,self.labels_id,self.reactions_id)
