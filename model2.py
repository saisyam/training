...
class Commit(Base):
    ...
    def __repr__(self):
        return "<Commit(id='{}',message='{}',url='{}',comment_count='{}')>"\
            .format(self.message, self.url, self.comment_count)
...
class Main(Base):
    ...
    author=relationship("Author",foreign_keys='Main.author_id')
    committer_id = Column(Integer,ForeignKey("committer.id"))
    committer=relationship("Committer",foreign_keys='Main.committer_id')
	
    
    def __repr__(self):
         return "<Main(id={},sha='{}',node_id='{}',url='{}',html_url='{}',comments_url='{}',parents_id={},commit_id='{}',commit_author_id={},commit_committer_id={},commit_tree_id={},commit_verification_id={},author_id={},committer_id={})>"\
                 .format(self.id,self.sha, self.node_id, self.url, self.html_url, self.comments_url,self.parents_id,self.commit_message,self.commit_author_id,self.commit_committer_id,self.commit_tree_id,self.commit_verification_id,self.author_id,self.committer_id)
